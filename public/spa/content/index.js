...
function create_each_block(ctx) {
	...
	var switch_value = /*allComponents*/ ctx[1]["layout_components_" + /*name*/ ctx[2] + "_svelte"];
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (switch_value !== (switch_value = /*allComponents*/ ctx[1]["layout_components_" + /*name*/ ctx[2] + "_svelte"])) {
				if (switch_instance) {
					group_outros();
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			if (dirty & /*allComponents, components*/ 3) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ("allComponents" in $$props) $$invalidate(1, allComponents = $$props.allComponents);
	};
...
class Component extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { components: 0, allComponents: 1 });
	}
}
