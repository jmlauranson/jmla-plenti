...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t8 = claim_text(div2_nodes, "Services");
			...
			t10 = claim_text(a3_nodes, "Skills");
			...
			t12 = claim_text(a4_nodes, "Technologies");
		...
		h() {
			...
			attr(i1, "class", "ti-linkedin");
			attr(a11, "href", "https://linkedin.com/in/jmlauranson");
