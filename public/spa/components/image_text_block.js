...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			...
			attr(i, "class", "ti-arrow-right");
			attr(a, "href", a_href_value = /*link*/ ctx[2].url);
			attr(a, "class", "btn-link");
			attr(div0, "class", div0_class_value = "col-md-6 order-" + /*textPos*/ ctx[4] + " order-md-" + /*textPosMD*/ ctx[5]);
			...
			attr(div2, "class", div2_class_value = "col-md-6 order-" + /*imgPos*/ ctx[6] + " order-md-" + /*imgPosMD*/ ctx[7] + " mb-4 mb-md-0");
			attr(div3, "class", "row align-items-center");
			attr(div4, "class", "container");
			attr(section, "class", "section mt-5");
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*textPos, textPosMD*/ 48 && div0_class_value !== (div0_class_value = "col-md-6 order-" + /*textPos*/ ctx[4] + " order-md-" + /*textPosMD*/ ctx[5])) {
			...
			if (dirty & /*imgPos, imgPosMD*/ 192 && div2_class_value !== (div2_class_value = "col-md-6 order-" + /*imgPos*/ ctx[6] + " order-md-" + /*imgPosMD*/ ctx[7] + " mb-4 mb-md-0")) {
...
function instance($$self, $$props, $$invalidate) {
	...
	return [title, body, link, image, textPos, textPosMD, imgPos, imgPosMD];
}
